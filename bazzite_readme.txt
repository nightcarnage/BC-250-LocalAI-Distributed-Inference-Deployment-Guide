...
The maximum I've tested is three nodes.
I'm currently having an issue where node 3 accepts RPC registration but never receives jobs. It appears as an RPC worker, but:

No work is assigned

No VRAM usage appears in nvtop

This may be user error on my part.
